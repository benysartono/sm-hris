...
<div class="container">
    <div class="row">
        <div class="col-md-9">
            ...
            <s:form id="bootstrapAjaxForm" action="login-mobile" method="post" theme="bootstrap" cssClass="well form-horizontal" label="Enter User Id and Password" validate="true">
                <s:textfield
                        label="User Id"
                        name="uid"
                        cssClass="input-sm"
