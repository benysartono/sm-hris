    ...
    <div class="row">
        <div class="col-md-9">
          ...
          <div class="panel-heading">
            <h1>Editing Employee Career</h1>
          </div>
          <div class="panel-body">
            <s:form id="frmEmployeeCareer" action="employee-career-edit" enctype="multipart/form-data" method="post" theme="bootstrap" cssClass="form-horizontal">
