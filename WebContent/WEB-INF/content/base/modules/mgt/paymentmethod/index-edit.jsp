    ...
    <div class="row">
        <div class="col-md-9">
          ...
          <div class="panel-heading">
            <h1>Editing Payment Method</h1>
          </div>
          <div class="panel-body">
			<div class="tab-content responsive">
            <s:form id="frmPaymentMethod" action="index-edit" enctype="multipart/form-data" method="post" theme="bootstrap" cssClass="form-horizontal">
                <div class="form-group">
                <div class="row">
                    <div class="col-md-9">
                		<s:textfield
                        	label="ID Payment Method"
                        	name="paymentMethod.idPaymentMethod"
                        	cssClass="input-sm"
                    ...
                    <div class="col-md-9">
                		<s:textfield
                        	label="Name"
                        	name="paymentMethod.nmPaymentMethod"
                        	cssClass="input-sm"
                        	elementCssClass="col-sm-3"
                        	tooltip="Enter Name"
                        	value="%{paymentMethod.nmPaymentMethod}"
                        	/>
                    </div>
