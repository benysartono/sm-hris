    ...
    <div class="row">
        <div class="col-md-9">
          ...
          <div class="panel-body">
            ...
            <s:form id="frmSupplier" action="index-edit" enctype="multipart/form-data" method="post" theme="bootstrap" cssClass="form-horizontal">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                		<s:textfield
                        	label="Name"
                        	name="supplier.nmSupplier"
                        	cssClass="input-sm"
                        	elementCssClass="col-sm-3"
                        	tooltip="Enter Name"
                        	value="%{supplier.nmSupplier}"
                        	/>
                    </div>
                    <div class="col-md-9">
                		<s:textfield
