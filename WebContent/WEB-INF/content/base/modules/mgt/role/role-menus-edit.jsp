...
<div class="panel-heading">
	<h1>Menu List for Role <s:property value="strParamIdRole" /></h1>
</div>
...
<!-- 
 ...
 -->	
	<div class="row">
        <div class="col-md-9">
			<form id="frmIdRole" method="post" action="role-menus-edit" theme="bootstrap" cssClass="form-horizontal" label="Role Delete">
			<div class="row">
	        	<div class="col-md-10">
				...
				<table width="100%" Class="table-responsive table-striped table-bordered">
					<thead>
						<tr>
							<td>
								<input type="checkbox" name="checkAll" onclick="for(c in document.getElementsByName('idMenus')) document.getElementsByName('idMenus').item(c).checked = this.checked" />
							</td>
							<td>
								ID Menu
							</td>
					...
					<s:iterator value="roleMenus">
						<tr>
							<td>       
								<input type="checkbox" <s:property value ="idRole"/> name="idMenus"  value="<s:property value ="idMenu"/>"></checkbox>
							</td>
							<td>       
